...
/**
 * DAO for creating {@link com.magmanics.licensing.service.model.Activation Activation}s. Retrieval is facilitated through the association 'activations' on {@link com.magmanics.licensing.service.model.Configuration Configuration}.
 *
